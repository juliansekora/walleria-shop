...
window.karteStart=function(pdp){
 ...
 for(let i=1;i<=n;i++){
  ...
  const map=new maplibregl.Map({container:wrap.querySelector(".map"),style:kpStyle(st.stil),center:[KP_BEISPIEL.lon,KP_BEISPIEL.lat],zoom:vor.z,attributionControl:false,dragRotate:false,pitchWithRotate:false,touchZoomRotate:true,preserveDrawingBuffer:true,fadeDuration:0,
  ...
  const c={i,el:wrap,wrap,map,cfg:{q:"",t:"",n1:"",n2:"",d:""},center:map.getCenter(),city:KP_BEISPIEL.q.split(",")[0],bsp,dirty:false,geo:false,kennung:"",stand:""};
