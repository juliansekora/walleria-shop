...
function ladeChatGptPixel(){
  ...
  /* page_viewed ohne Eigenschaften: mit {type:"customer_action"} lehnte OpenAI 246 Ereignisse als
     "ungueltige Ereigniseigenschaften" ab, contents_viewed kam sauber an (04.09.2026) */
